  ...
  const works = [
    {
      ...
      category: 'dragon',
      image:
        'https://images.unsplash.com/photo-1598371839696-5c5bb00bdc28?w=600&h=800&fit=crop',
      description:
        'Full back piece featuring traditional Japanese dragon',
    },
    {
      id: 2,
              ...
              {filteredWorks.map((work) => (
                ...
                >
                  ...
                  <div className="relative aspect-[3/4] p-4">
                    ...
                    {/* Smaller Image */}
                    <div className="absolute inset-0 z-20 px-24 py-28">
                      <img
                        src={work.image}
                        alt={work.title}
                        className="
                    ...
                    {/* Overlay */}
                    <div className="absolute inset-0 z-30 bg-gradient-to-t from-black/20 via-transparent to-transparent pointer-events-none" />
                  </div>

                  {/* TEXT BELOW FRAME */}
                  <div className="mt-6 text-center">
                    <span className="text-blood-red text-[10px] tracking-[0.4em] font-bold block mb-3 uppercase">
                      {getCategoryLabel(work.category)}
                    </span>

                    <h3 className="font-gothic text-3xl text-soft-white uppercase tracking-wide">
                      {work.title}
                    </h3>
                  </div>
                </motion.div>
          ...
          >
            ...
            >
              ...
              <div className="md:w-1/2 p-10 flex flex-col justify-center">
                <h2 className="font-gothic text-3xl text-soft-white mb-4 uppercase">
                  {selectedWork.title}
                </h2>

                <p className="text-soft-white/60 mb-8">
