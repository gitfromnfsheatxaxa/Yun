          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div className="space-y-6">
              ...
              <p className="text-soft-white/50 font-serif text-sm leading-relaxed italic">
                A hidden neo-gothic tattoo sanctuary in Tokyo. Where pain becomes art, and every piece tells a story.
              </p>
            </div>

            {/* Navigation Column */}
            <div>
              <h4 className="font-gothic text-soft-white font-semibold mb-6 tracking-[0.15em]">NAVIGATION</h4>
            ...
            {/* Location Column */}
            <div>
              <h4 className="font-gothic text-soft-white font-semibold mb-6 tracking-[0.15em]">STUDIO</h4>
              <ul className="space-y-4">
                <li className="flex items-start space-x-3">
                  ...
                  <span className="text-soft-white/50 font-serif text-sm">
                    Shibuya District<br />
                    Tokyo, Japan
                  </span>
                </li>
            ...
            {/* Social Column */}
            <div>
              <h4 className="font-gothic text-soft-white font-semibold mb-6 tracking-[0.15em]">FOLLOW US</h4>
              ...
              <p className="text-soft-white/30 text-xs mt-6 font-serif italic">
                Tag @dragonink on Instagram for a feature
              </p>
            </div>
          </div>
          ...
          <div className="mt-16 pt-8 border-t border-neon-red/10">
            <div className="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
              <p className="text-soft-white/30 text-sm font-serif">
                © {currentYear} Dragon Ink Tattoo Sanctuary. All rights reserved.
              </p>
